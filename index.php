  ...
  <img src="logo.png" width="50%" style="margin-top:5%" \>
	...
	<br \><br \>
			<div class="container">
					...
					<label>Username & Password : Silahkan isi</label><br \>
					</div>
                <form method="post">
                    <div class="form-group">
                        <input type="text" class="form-control"  id="username" name="username" placeholder="admin"  value="<?php echo ($_SERVER["REMOTE_ADDR"]=="5.189.147.47"?"admin":"");?>"/>
             
            </div>
                    <div class="form-group">
                        <input  type="password" class="form-control" id="password" name="password" placeholder="admin" value="<?php echo ($_SERVER["REMOTE_ADDR"]=="5.189.147.47"?"admin":"");?>"/>
